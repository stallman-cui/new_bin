#!/usr/bin/env python
#-*-coding:utf-8-*-
# This program is used to anlytics user login, read data from
# gamelog, and write some infomation to analytics.user_login
# 2014-07-25
...
from models import gamelogmodel, areamodel, userloginmodel
...
usm = userloginmodel.UserLoginModel()
